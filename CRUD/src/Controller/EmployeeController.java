...
public class EmployeeController {
    ...
    private void populateFieldsFromSelectedRow() {
        ...
        if (selectedRow > -1) { 
            view.getFirstName().setText(view.getTable().getValueAt(selectedRow, 1).toString());
            view.getLastName().setText(view.getTable().getValueAt(selectedRow, 2).toString());
            view.getEmail().setText(view.getTable().getValueAt(selectedRow, 3).toString());
            view.getPhone().setText(view.getTable().getValueAt(selectedRow, 4).toString());
            view.getSalary().setText(view.getTable().getValueAt(selectedRow, 5).toString());
            view.getRoles().setSelectedItem(Role.valueOf(view.getTable().getValueAt(selectedRow, 6).toString()));
            view.getPostes().setSelectedItem(Poste.valueOf(view.getTable().getValueAt(selectedRow, 7).toString()));
        }
    }
